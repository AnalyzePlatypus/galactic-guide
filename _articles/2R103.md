...
footnotes: 
  - 1:
    number: 1
    text: "&quot;Wild&quot; meaning: &quot;afraid of humans due hunting experiences.&quot; This, opposed to the true &quot;wild&quot;: &quot;what kind of upright walking animal is that!&quot;"
  - 2:
    number: 2
    text: "I will not translate that sooner than I know exactly what that means; the Dutch know why."
  - 3:
    number: 3
    text: "Dutch folkloristic dances suck!"
...
<p>The signs that point to this place ("Bosrand 18") that have generously been spread all over the Dwingeloo area indicate that you can also go there for: parties, children's garden parties, droppings (not the odourous ones), "klootschieten" <a href="#footnote-body.2" name="footnote-link.2" class="footnote-link">[2]</a>, cycling, covered wagons, and the exhibition garden (oh, I mentioned that one already).</p>
